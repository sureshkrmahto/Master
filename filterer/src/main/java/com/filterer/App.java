...
import com.filterer.threat.ProbableThreat;
import com.filterer.threat.SimpleProbabilisticThreatAwareSystem;
import com.filterer.threat.SimpleProbableThreat;
import com.filterer.threat.SimpleThreat;
import com.filterer.threat.SimpleThreatAwareSystem;
import com.filterer.threat.Threat;
import com.filterer.threat.ThreatAwareSystem;
import com.filterer.threat.ThreatType;
...
/**
 * This demo class represent how {@link com.filterer.domain.Filterer} pattern is used to
...
filteringSimpleProbableThreats();
  ...
  /**
   * Demonstrates how to filter {@link com.filterer.threat.ProbabilisticThreatAwareSystem}
   * based on probability property. The @{@link com.filterer.domain.Filterer#by(Predicate)}
   * method is able to use {@link com.filterer.threat.ProbableThreat}
...
LOGGER.info("Filtered by probability = 0.99 : " + filteredThreatAwareSystem);
   ...
   * of {@link SimpleThreat}. The @{@link com.filterer.domain.Filterer#by(Predicate)}
