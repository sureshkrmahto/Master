...
import com.hexagonal.domain.LotteryAdministration;
import com.hexagonal.domain.LotteryService;
import com.hexagonal.module.LotteryTestingModule;
import com.hexagonal.sampledata.SampleData;
 ...
 * com.hexagonal.administration.ConsoleAdministration} through which the lottery round is
 * initiated and run and {@link com.hexagonal.service.ConsoleLottery} that allows players
 * to submit lottery tickets for the draw.
 *
 * <p>The secondary ports that application core uses are{@link
 * com.hexagonal.banking.WireTransfers} which is a banking service, {@link
 * com.hexagonal.eventlog.LotteryEventLog} that delivers eventlog as lottery events occur
 * and {@link com.hexagonal.database.LotteryTicketRepository} that is the storage for the
 * lottery tickets.
